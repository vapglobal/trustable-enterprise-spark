...
- [ ] Owner bound to secure env setting (TRUSTABLE_OWNER_EMAIL), no first-signup bootstrap
- [ ] Tenant RBAC: configurable roles, least-privilege permissions, groups, per-user grant/deny overrides; protect every workspace
